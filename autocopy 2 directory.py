...
def main():
    ...
    copy_folder_path1 = os.getenv("copy_folder_f")
    copy_folder_path2 = os.getenv("copy_folder_f1")

    f = FolderCopier(
        main_folder_path=main_folder_path1,
        copy_folder_path=copy_folder_path1,
        from_what_amount_of_files_per_folder_to_copy=5,
    )
    f1 = FolderCopier(
        main_folder_path=main_folder_path1,
        copy_folder_path=copy_folder_path2,
        from_what_amount_of_files_per_folder_to_copy=5,
    )
